#define MUSIC_LIST_NUM 0x1e

const char *musicStrmListNormal[MUSIC_LIST_NUM] = {
    0,
    "STRM_BGM_CHIJOU",
    "STRM_BGM_CHIKA",
    "STRM_BGM_WATER",
...
const char *musicStrmListFast[MUSIC_LIST_NUM] = {
    0,
...
const char *musicSeqListNormal[MUSIC_LIST_NUM] = {
    0,
    "SEQ_BGM_CHIJOU_V",
    "SEQ_BGM_CHIKA_V",
    "SEQ_BGM_WATER_V",
...
const char *musicSeqListFast[MUSIC_LIST_NUM] = {
    0,
